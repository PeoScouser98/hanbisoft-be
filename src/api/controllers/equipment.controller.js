...
export default class EquipmentController {
	 ...
	 * @method GET
	 */
	static getAllEquipments = HttpRequest(async (req, res) => {
	 ...
	 * @method GET
	 */
	static getLookupValues = HttpRequest(async (req, res) => {
	 ...
	 * @method PUT
	 */
	static updateEquipments = HttpRequest(async (req, res) => {
	 ...
	 * @method DELETE
	 */
	static deleteEquipments = HttpRequest(async (req, res) => {
